...
class PTCLTrainer():
    ...
    def set_data(self, employee):
        ...
        self.AreaOfSpecialization=employee['AreaOfSpecialization']
        self.Organizations=employee['Organizations']
    ...
    def save_to_db(self, employee):
        ...
        collection = connection.set_collection('Trainers')
